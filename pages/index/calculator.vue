<template>
    <v-col>
        <v-row justify="center" align="center">
            ...
            <v-text-field hint="Число → валюта → in → валюта" light outlined label="Введите функцию изменения валюты"
                placeholder="100 AMD in RUB" color="blue" hide-details="auto" class="blue--text" @input=" inputAction"></v-text-field>
        </v-row>
        <v-row justify="space-between">
            <v-card width="100%"  color="white" elevation="0" class="mt-3">
                <v-row justify="space-between" >
                    ...
                    <v-col v-if="to" xs="12" cols="12"  sm="2" class="mt-auto mb-auto" align="center" justify="center" height="100%">
